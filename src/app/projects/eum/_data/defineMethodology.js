const defineMethodology = [
    ...
    },
    {
        title: "환자 · 의료진 통합 분석",
        headline:
            "핵심은 정보 부족이 아니라,\n짧은 진료 안에서 의사의 판단이 환자에게 왜 그런지와\n진료 후 어떻게 해야 하는지까지 충분히 설명되지 않는다는 점이었습니다.",
        paragraphs: [
    ...
    },
    {
        title: "UX 전략 및 문제 정의",
        headline:
            "환자는 증상에 대한 설명과 이후 방향을 듣고 싶었고,\n의사는 판단에 필요한 핵심 증상 정보를 먼저 파악하고 싶었습니다.",
        paragraphs: [
