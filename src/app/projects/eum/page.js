            ...
            <section className="section section-dd-develop-usability-testing section-half-padding">
                <div className="section-content">
                    ...
                    <div className="ut-results">
                        <h4 className="visuallyhidden">Usability Testing Results</h4>
                        <div className="ut-result-item">
                            <h5 className="headline">
                                01. 사용성은 확인됐지만, 핵심 가치는 바로 읽히지 않았습니다.
                            </h5>
                            <p>
                                환자 앱의 사용성 점수는 76.5점, 의사용 패널은 75점. 기본 사용성은
                                나쁘지 않았지만, 핵심은 어떤 가치로 읽히는가였습니다.
                            </p>
                            <figure className="screenshot">
                                <div className="image-wrapper"></div>
                                <figcaption>
                                    시스템 사용성 척도(SUS) 결과표입니다. SUS는 10개 문항을
                                    0~100점으로 환산한 사용성 지표로, 평균값은 전체 수준, 표준편차는
                                    평가 차이, 중앙값은 극단값에 덜 흔들리는 대표값을 보여줍니다.
                                    환자 앱은 평균 76.5점으로 기본 사용성이 나쁘지 않았고, 의사용
                                    패널은 75점이었지만 표본이 1명이라 참고 수준으로 해석했습니다
                                </figcaption>
                            </figure>
                        </div>
                        <div className="ut-result-item">
                            ...
                            <p>
                                ...
                                기록 이해 과업은 4.6점으로 가장 낮았습니다. 반복된 질문은 &quot;왜
                                이런 판단인지&quot;와 &quot;어떻게 관리해야 하는지&quot;였습니다.
                            </p>
                            <figure className="screenshot">
                                <div className="image-wrapper"></div>
                                <figcaption>
                                    순차 과업 난이도(SEQ) 결과표입니다. 환자 과업 중에서는 메인
                                    화면과 기록 이해(4.6점) 가 가장 어려웠고, 증상 기록(6.2점) 이
                                    가장 수월하게 평가됐습니다.
                                </figcaption>
                            </figure>
                        </div>
                        ...
                        <div className="ut-result-item">
                            ...
                            <p>
                                ...
                                문제로 봤습니다. 즉 환자와 의사의 반응이 보여준 문제를, 전문가
                                평가가 정보 구조의 관점에서 다시 확인해준 셈이었습니다.
                            </p>
                        </div>
                        <div className="ut-result-item">
                            <h5 className="headline">이번 사용성 테스트의 한계.</h5>
                            <p>
                                번 테스트는 방향성 확인에는 유효했지만, 일반화에는 한계가 있습니다.
